...
Yilan_poz = [400, 400]
Yilan_Govde = [[400, 400], [400 - 10, 400], [400 - 20, 400]]

Yem_poz = [random.randrange(10, (Pencere_Genislik // 10)) * 10, random.randrange(1, (Pencere_Yukseklik // 10)) * 10]
Yem_durumu = True
